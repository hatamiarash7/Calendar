...
public class SolarPosition {
    ...
    static private double limitDegrees(double degrees) {
        double limited;
        degrees /= 360.0;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    static private double greenwichMeanSiderealTime(double jd) {
    ...
    static private double greenwichSiderealTime(double ν0, double Δψ, double ε) {
    ...
    @Contract(pure = true)
    private double getGeocentricLatitude(double b) {
        return -b;
    }

    @Contract(pure = true)
    private double geocentricLongitude(double L) {
    ...
    double atmosphericRefractionCorrection(double pressure,
                                           double temperature,
                                           double atmosRefract,
                                           double e0) {
        double Δe = 0;
    ...
    double surfaceIncidenceAngle(double zenith,
                                 double azimuth180,
                                 double azmRotation,
                                 double slope) {
    ...
    private void approxSalatTimes(double[] mRts, double[] h0) {
    ...
    private void approxKerahatTimes(double[] mRts, double[] h0) {
    ...
    double sunRiseAndSet(double[] mRts,
                         double[] hRts,
                         double[] δPrime,
                         double latitude,
                         double[] hPrime,
    ...
    private Equatorial calculateSunEquatorialCoordinates(double jd, double ΔT) {
