package ir.hatamiarash.calendar.util;
...
import static ir.hatamiarash.calendar.Constants.ARABIC_DIGITS;
import static ir.hatamiarash.calendar.Constants.BROADCAST_ALARM;
import static ir.hatamiarash.calendar.Constants.BROADCAST_RESTART_APP;
import static ir.hatamiarash.calendar.Constants.DARK_THEME;
import static ir.hatamiarash.calendar.Constants.DAYS_ICONS;
import static ir.hatamiarash.calendar.Constants.DAYS_ICONS_AR;
import static ir.hatamiarash.calendar.Constants.DEFAULT_ALTITUDE;
import static ir.hatamiarash.calendar.Constants.DEFAULT_APP_LANGUAGE;
import static ir.hatamiarash.calendar.Constants.DEFAULT_ATHAN_VOLUME;
import static ir.hatamiarash.calendar.Constants.DEFAULT_CITY;
import static ir.hatamiarash.calendar.Constants.DEFAULT_IRAN_TIME;
import static ir.hatamiarash.calendar.Constants.DEFAULT_ISLAMIC_OFFSET;
import static ir.hatamiarash.calendar.Constants.DEFAULT_LATITUDE;
import static ir.hatamiarash.calendar.Constants.DEFAULT_LONGITUDE;
import static ir.hatamiarash.calendar.Constants.DEFAULT_NOTIFY_DATE;
import static ir.hatamiarash.calendar.Constants.DEFAULT_PERSIAN_DIGITS;
import static ir.hatamiarash.calendar.Constants.DEFAULT_PRAY_TIME_METHOD;
import static ir.hatamiarash.calendar.Constants.DEFAULT_SELECTED_WIDGET_TEXT_COLOR;
import static ir.hatamiarash.calendar.Constants.DEFAULT_WIDGET_CLOCK;
import static ir.hatamiarash.calendar.Constants.DEFAULT_WIDGET_IN_24;
import static ir.hatamiarash.calendar.Constants.FONT_PATH;
import static ir.hatamiarash.calendar.Constants.KEY_EXTRA_PRAYER_KEY;
import static ir.hatamiarash.calendar.Constants.LIGHT_THEME;
import static ir.hatamiarash.calendar.Constants.PERSIAN_COMMA;
import static ir.hatamiarash.calendar.Constants.PERSIAN_DIGITS;
import static ir.hatamiarash.calendar.Constants.PM_IN_PERSIAN;
import static ir.hatamiarash.calendar.Constants.PREF_ALTITUDE;
import static ir.hatamiarash.calendar.Constants.PREF_APP_LANGUAGE;
import static ir.hatamiarash.calendar.Constants.PREF_ATHAN_ALARM;
import static ir.hatamiarash.calendar.Constants.PREF_ATHAN_GAP;
import static ir.hatamiarash.calendar.Constants.PREF_ATHAN_VOLUME;
import static ir.hatamiarash.calendar.Constants.PREF_GEOCODED_CITYNAME;
import static ir.hatamiarash.calendar.Constants.PREF_IRAN_TIME;
import static ir.hatamiarash.calendar.Constants.PREF_ISLAMIC_OFFSET;
import static ir.hatamiarash.calendar.Constants.PREF_LATITUDE;
import static ir.hatamiarash.calendar.Constants.PREF_LONGITUDE;
import static ir.hatamiarash.calendar.Constants.PREF_NOTIFY_DATE;
import static ir.hatamiarash.calendar.Constants.PREF_PERSIAN_DIGITS;
import static ir.hatamiarash.calendar.Constants.PREF_PRAY_TIME_METHOD;
import static ir.hatamiarash.calendar.Constants.PREF_SELECTED_LOCATION;
import static ir.hatamiarash.calendar.Constants.PREF_SELECTED_WIDGET_TEXT_COLOR;
import static ir.hatamiarash.calendar.Constants.PREF_THEME;
import static ir.hatamiarash.calendar.Constants.PREF_WIDGET_CLOCK;
import static ir.hatamiarash.calendar.Constants.PREF_WIDGET_IN_24;
...
public class Utils {
    ...
    public CalculationMethod getCalculationMethod() {
        ...
        return CalculationMethod.valueOf(prefs.getString(PREF_PRAY_TIME_METHOD, DEFAULT_PRAY_TIME_METHOD));
    }

    public int getIslamicOffset() {
        return Integer.parseInt(prefs.getString(PREF_ISLAMIC_OFFSET, DEFAULT_ISLAMIC_OFFSET).replace("+", ""));
    }
    ...
    public void updateStoredPreference() {
        preferredDigits = isPersianDigitSelected() ? PERSIAN_DIGITS : ARABIC_DIGITS;
    ...
    private void setAlarm(PrayTime prayTime, long timeInMillis, int id) {
        ...
        if (!triggerTime.before(Calendar.getInstance())) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT)
                SetExactAlarm.setExactAlarm(alarmManager, AlarmManager.RTC_WAKEUP, triggerTime.getTimeInMillis(), pendingIntent);
            else
    ...
    private static class SetExactAlarm {
        ...
        static void setExactAlarm(AlarmManager alarmManager, int type, long triggerAtMillis, PendingIntent pendingIntent) {
